...
HEALBOT_HELP2={ [1] = "[HealBot] /hb d -- Restaurar opciones por defecto",
                ...
                [6] = "[HealBot] /hb pcs <n> -- Ajusta el tamaño del indicador de carga de poder sagrado por <n>, Valor por defecto es 7 ",
...
HEALBOT_OPTIONS_SAME_AS_HLTH_FUTURE     = "Igual que la salud (Salud futura)"
HEALBOT_OPTIONS_FUTURE_HLTH             = "Salud futura"
HEALBOT_SKIN_HEALTHBARCOL_TEXT          = "Barra de salud";
HEALBOT_SKIN_HEALTHBACKCOL_TEXT         = "Barras secundarias";
HEALBOT_SKIN_INCHEALBARCOL_TEXT         = "Sanaciones futuras";
...
HEALBOT_PLAYER_OF_REALM                 = "de"
    ...
    HEALBOT_OPTIONS_LANG_ESES               = "Spanish (esES - by milotic)"
