...
function HealBot_Lang_Options_enALL()
    ...
    local hbSpellsTips8="\n--\n".._G["ORANGE_FONT_COLOR_CODE"].."NOTE: In case of a conflict between these settings, the following applies.\n".._G["ORANGE_FONT_COLOR_CODE"].."The settings used will be in the following order:.\n".._G["ORANGE_FONT_COLOR_CODE"].."1. Include Target\n".._G["ORANGE_FONT_COLOR_CODE"].."2. Include Tank targets\n".._G["ORANGE_FONT_COLOR_CODE"].."3. Include Group targets\n".._G["ORANGE_FONT_COLOR_CODE"].."4. Include Private List targets.\n--\n".._G["ORANGE_FONT_COLOR_CODE"].."An example of a conflict that may arise, is when a tank is part of your group,\n".._G["ORANGE_FONT_COLOR_CODE"].."and both the Include Tank targets and Include Group targets are turned on.\n".._G["ORANGE_FONT_COLOR_CODE"].."In this case, Tank settings for When out of combat and When entering combat will be used."
