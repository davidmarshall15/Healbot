...
-- Class
    ...
    HEALBOT_ZONE_AB                         = C_Map.GetMapInfo(93).name or "Низина Арати";
    HEALBOT_ZONE_AV                         = C_Map.GetMapInfo(91).name or "Альтеракская долина";
    HEALBOT_ZONE_ES                         = C_Map.GetMapInfo(121).name or "Око Бури";
    HEALBOT_ZONE_IC                         = C_Map.GetMapInfo(169).name or "Остров Завоеваний";
    HEALBOT_ZONE_SA                         = C_Map.GetMapInfo(128).name or "Берег Древних";
