...
General~t!{HIDEBOSSF="true",HIDEPARTYF="false",HIDEPTF="false",STICKYSENSITIVITY=20,HIDERAIDF="true",STICKYFRAME="true",FLUIDBARS="true",FLUIDFREQ=4}
...
Enemy~t!{INCARENA="false",INCTANKS="true",INCMYTAR="false",ENEMYTARGET="true",ENEMYTARGETSIZE=70,INCARENAPETS="false",INCSELF="false",NUMBOSS=4,EXISTSHOWPTAR="false",HIDE="true",EXISTSHOWBOSS="true",DOUBLEWIDTH="false",EXISTSHOWARENA="false"}
...
FrameAlias~f~8!{SIZE=12,NAME="Target",R=1,ALIAS="Target",G=1,SHOW="true",OFFSET=10,FONT="Friz Quadrata TT",A=1,B=1,OUTLINE=1}
...
Frame~f~1!{BACKR=0.02,BACKG=0.016,TIPLOC=2,BACKB=0.016,LOCKED="false",SCALE=1,BORDERA=0,SFOFFSETV=0,AUTOCLOSE="false",BORDERB=0,BACKA=0.33,OPENSOUND="false",BORDERG=0,SFOFFSETH=0,BORDERR=0.976}
Frame~f~2!{BACKR=0.102,BACKG=0.102,TIPLOC=1,BACKB=0.502,LOCKED="true",SCALE=1,BORDERA=0,SFOFFSETV=0,AUTOCLOSE="false",BORDERB=0.102,BACKA=0.04,OPENSOUND="false",BORDERG=0.102,SFOFFSETH=2,BORDERR=0.102}
Frame~f~3!{BACKR=0.1,BACKG=0.1,TIPLOC=2,BACKB=0.5,LOCKED="false",SCALE=1,BORDERA=0.5,SFOFFSETV=0,AUTOCLOSE="false",BORDERB=0.1,BACKA=0.2,OPENSOUND="false",BORDERG=0.1,SFOFFSETH=0,BORDERR=0.1}
Frame~d!4~
Frame~f~5!{BACKR=0.1,BACKG=0.1,TIPLOC=4,BACKB=0.5,LOCKED="false",SCALE=1,BORDERA=0.5,SFOFFSETV=0,AUTOCLOSE="false",BORDERB=0.1,BACKA=0.2,OPENSOUND="false",BORDERG=0.1,SFOFFSETH=0,BORDERR=0.1}
Frame~f~6!{BACKR=0.1,BACKG=0.1,TIPLOC=5,BACKB=0.5,LOCKED="false",SCALE=1,BORDERA=0.5,SFOFFSETV=0,AUTOCLOSE="false",BORDERB=0.1,BACKA=0.2,OPENSOUND="false",BORDERG=0.1,SFOFFSETH=0,BORDERR=0.1}
Frame~f~7!{BACKR=0.102,BACKG=0.102,TIPLOC=5,BACKB=0.502,LOCKED="true",SCALE=1,BORDERA=0.01,SFOFFSETV=7,AUTOCLOSE="false",BORDERB=0.102,BACKA=0.01,OPENSOUND="false",BORDERG=0.102,SFOFFSETH=0,BORDERR=0.102}
Frame~f~8!{BACKR=0.102,BACKG=0.102,TIPLOC=5,BACKB=0.502,LOCKED="false",SCALE=1,BORDERA=0,SFOFFSETV=4,AUTOCLOSE="false",BORDERB=0.102,BACKA=0,OPENSOUND="false",BORDERG=0.102,SFOFFSETH=8,BORDERR=0.102}
Frame~f~9!{BACKR=0.102,BACKG=0.102,TIPLOC=5,BACKB=0.502,LOCKED="false",SCALE=1,BORDERA=0,SFOFFSETV=0,AUTOCLOSE="false",BORDERB=0.102,BACKA=0,OPENSOUND="false",BORDERG=0.102,SFOFFSETH=8,BORDERR=0.102}
Frame~f~10!{BACKR=0.102,BACKG=0.102,TIPLOC=2,BACKB=0.502,LOCKED="false",SCALE=1,BORDERA=0.1,SFOFFSETV=0,AUTOCLOSE="false",BORDERB=0.102,BACKA=0.05,OPENSOUND="false",BORDERG=0.102,SFOFFSETH=0,BORDERR=0.102}
...
Anchors~f~1!{Y=68.67,GROW=2,BARS=1,FRAME=3,X=95.03}
...
Anchors~f~8!{Y=69,GROW=2,BARS=1,FRAME=3,X=88.72}
Anchors~f~9!{Y=63.76,GROW=2,BARS=1,FRAME=7,X=88.81}
Anchors~f~10!{Y=70.34,GROW=2,BARS=4,FRAME=2,X=88.44}
...
BarCol~f~1!{BACK=3,BA=0.2,BB=0.02,DISA=0,BR=0.02,HB=0.9,BG=0.02,HG=0.2,HA=1,HR=0.2,ORA=0.25,BOUT=0,HLTH=2}
BarCol~f~2!{BACK=3,BA=0.2,BOUT=2,DISA=0,BR=0.02,HB=0.9,BG=0.02,BB=0.02,HA=1,HG=0.2,ORA=0.5,HR=0.2,HLTH=2}
...
BarText~f~1!{HLTHONBAR="true",TAGOOR="OOR | ",IGNOREONFULL="true",MAXCHARS=0,CLASSONBAR="true",HOFFSET=1,HHEIGHT=14,HMAXCHARS=0,INCHEALS=2,HLTHTXTANCHOR=1,FONT="Friz Quadrata TT",OUTLINE=1,CLASSTYPE=1,NUMFORMAT2=1,HLTHTYPE=1,TAGDC="[ DC ] ",NUMFORMAT1=11,NAMEONBAR="true",HEIGHT=13,TAGRIP="RIP | ",SHOWROLE="true",HALIGN=2,HOUTLINE=1,OVERHEAL=1,OFFSET=3,INCABSORBS=1,HOFFSET2=0,ALIGN=2,TAGR="[ R ] ",HFONT="Friz Quadrata TT"}
BarText~f~2!{HLTHONBAR="true",TAGOOR="OOR | ",IGNOREONFULL="false",MAXCHARS=0,CLASSONBAR="true",HOFFSET=1,HHEIGHT=14,HMAXCHARS=0,INCHEALS=2,HLTHTXTANCHOR=1,FONT="Friz Quadrata TT",OUTLINE=1,CLASSTYPE=1,NUMFORMAT2=1,HLTHTYPE=1,TAGDC="[ DC ] ",NUMFORMAT1=11,NAMEONBAR="true",HEIGHT=13,TAGRIP="RIP | ",SHOWROLE="true",HALIGN=2,HOUTLINE=1,OVERHEAL=1,OFFSET=3,INCABSORBS=1,HOFFSET2=0,ALIGN=2,TAGR="[ R ] ",HFONT="Friz Quadrata TT"}
BarText~f~3!{HLTHONBAR="true",TAGOOR="OOR | ",OVERHEAL=1,MAXCHARS=0,HMAXCHARS=0,OUTLINE=1,HOUTLINE=1,IGNOREONFULL="false",OFFSET=3,HLTHTXTANCHOR=1,FONT="Friz Quadrata TT",CLASSONBAR="true",CLASSTYPE=1,NUMFORMAT2=1,HLTHTYPE=1,TAGDC="[ DC ] ",NUMFORMAT1=11,NAMEONBAR="true",HEIGHT=13,TAGRIP="RIP | ",SHOWROLE="true",HALIGN=2,HHEIGHT=14,INCHEALS=2,HOFFSET=0,INCABSORBS=1,HOFFSET2=0,ALIGN=2,TAGR="[ R ] ",HFONT="Friz Quadrata TT"}
BarText~f~4!{HLTHONBAR="true",TAGOOR="OOR | ",OVERHEAL=1,MAXCHARS=0,CLASSONBAR="true",OUTLINE=1,IGNOREONFULL="true",HMAXCHARS=0,INCHEALS=2,HLTHTXTANCHOR=1,FONT="Friz Quadrata TT",HHEIGHT=14,CLASSTYPE=1,NUMFORMAT2=1,HLTHTYPE=1,TAGDC="[ DC ] ",HOFFSET=1,NAMEONBAR="true",HEIGHT=13,TAGRIP="RIP | ",SHOWROLE="true",HALIGN=2,HOUTLINE=1,NUMFORMAT1=11,OFFSET=3,INCABSORBS=1,HOFFSET2=0,ALIGN=2,TAGR="[ R ] ",HFONT="Friz Quadrata TT"}
BarText~f~5!{HLTHONBAR="true",TAGOOR="OOR | ",HOUTLINE=1,MAXCHARS=0,CLASSONBAR="true",HOFFSET=1,OUTLINE=1,HMAXCHARS=0,OFFSET=3,HLTHTXTANCHOR=1,FONT="Friz Quadrata TT",HHEIGHT=10,CLASSTYPE=1,NUMFORMAT2=1,HLTHTYPE=1,TAGDC="[ DC ] ",NUMFORMAT1=11,NAMEONBAR="true",HEIGHT=13,TAGRIP="RIP | ",SHOWROLE="true",HALIGN=2,IGNOREONFULL="true",OVERHEAL=1,INCHEALS=2,INCABSORBS=1,HOFFSET2=0,ALIGN=2,TAGR="[ R ] ",HFONT="Friz Quadrata TT"}
BarText~f~6!{HLTHONBAR="true",TAGOOR="OOR | ",HOUTLINE=1,MAXCHARS=0,CLASSONBAR="true",HFONT="Friz Quadrata TT",HMAXCHARS=0,HHEIGHT=10,OFFSET=3,HLTHTXTANCHOR=1,FONT="Friz Quadrata TT",OVERHEAL=1,CLASSTYPE=1,NUMFORMAT2=1,HLTHTYPE=1,NUMFORMAT1=11,IGNOREONFULL="true",NAMEONBAR="true",HEIGHT=13,TAGRIP="RIP | ",SHOWROLE="true",HALIGN=2,HOFFSET=1,TAGDC="[ DC ] ",INCHEALS=2,INCABSORBS=1,HOFFSET2=0,ALIGN=2,TAGR="[ R ] ",OUTLINE=1}
BarText~d!7~8~9~
BarText~f~10!{HLTHONBAR="true",TAGOOR="OOR | ",HOUTLINE=1,MAXCHARS=0,CLASSONBAR="false",HFONT="Friz Quadrata TT",HMAXCHARS=0,HHEIGHT=10,OFFSET=3,HLTHTXTANCHOR=1,FONT="Friz Quadrata TT",OVERHEAL=1,CLASSTYPE=1,NUMFORMAT2=1,HLTHTYPE=1,NUMFORMAT1=11,IGNOREONFULL="true",NAMEONBAR="true",HEIGHT=13,TAGRIP="RIP | ",SHOWROLE="true",HALIGN=2,HOFFSET=1,TAGDC="[ DC ] ",INCHEALS=2,INCABSORBS=1,HOFFSET2=0,ALIGN=2,TAGR="[ R ] ",OUTLINE=1}
BarTextCol~f~1!{HCG=0,NCR=0.996,HCDA=0.5,NCDA=0.8,NAME=2,HCA=1,NCG=0.91,HCR=0,NCA=1,HCB=0,NDEBUFF="true",HDEBUFF="false",NCB=0,HLTH=1}
BarTextCol~d!2~3~4~5~6~7~8~9~10~
Icons~f~1!{SHOWBUFF="true",SHOWDEBUFF="true",MAXDICONS=4,FADESECS=15,I15EN="true",SHOWDIRMOUSE="false",SHOWDIR="false",DOUBLE="true",DSCALE=1,ONBAR=1,SHOWRC="true",SCALE=1,FADE="false",POSITION=2,MAXBICONS=8}
Icons~d!2~3~4~5~6~
Icons~f~7!{SHOWBUFF="true",SHOWDEBUFF="true",MAXDICONS=2,FADESECS=15,I15EN="true",SHOWDIRMOUSE="false",SHOWDIR="false",DOUBLE="true",DSCALE=1,ONBAR=1,SHOWRC="true",SCALE=1,FADE="false",POSITION=2,MAXBICONS=4}
Icons~f~8!{SHOWBUFF="true",SHOWDEBUFF="true",MAXDICONS=4,FADESECS=15,I15EN="true",SHOWDIRMOUSE="false",SHOWDIR="false",DOUBLE="true",DSCALE=1,ONBAR=1,SHOWRC="true",SCALE=1,FADE="false",POSITION=2,MAXBICONS=8}
Icons~d!9~10~
...
AuxBarFrame~f~2!{OFREQ=0.07,OVERLAP=1,OMIN=0.1,OMAX=1}
AuxBarFrame~d!3~4~5~6~7~8~9~10~
AuxBar^1~f~1!{SIZE=1,USE=6,R=0.7,COLOUR=1,ANCHOR=2,OFFSET=0,DEPTH=3,G=0.7,A=1,OTYPE=1,B=0.2}
AuxBar^1~f~2!{SIZE=1,USE=6,B=0.2,COLOUR=1,ANCHOR=2,OFFSET=1,DEPTH=5,R=0.7,OTYPE=1,A=1,G=0.7}
AuxBar^1~d!3~4~5~6~7~8~9~
AuxBar^1~f~10!{SIZE=1,USE=1,B=0.2,COLOUR=1,ANCHOR=2,OFFSET=1,DEPTH=5,R=0.7,OTYPE=1,A=1,G=0.7}
AuxBar^2~f~1!{SIZE=1,USE=4,R=0.067,COLOUR=1,ANCHOR=1,OFFSET=0,DEPTH=3,G=0.918,A=1,OTYPE=1,B=0.035}
AuxBar^2~f~2!{SIZE=1,USE=4,B=0.035,COLOUR=1,ANCHOR=1,OFFSET=0,DEPTH=5,R=0.067,OTYPE=1,A=1,G=0.918}
AuxBar^2~d!3~4~5~6~7~8~9~
AuxBar^2~f~10!{SIZE=1,USE=1,B=0.035,COLOUR=1,ANCHOR=1,OFFSET=0,DEPTH=5,R=0.067,OTYPE=1,A=1,G=0.918}
AuxBar^3~f~1!{SIZE=0.58,USE=9,R=0.7,COLOUR=1,ANCHOR=2,OFFSET=-3,DEPTH=3,G=0.7,A=1,OTYPE=2,B=0.2}
AuxBar^3~f~2!{SIZE=0.58,USE=9,B=0.2,COLOUR=1,ANCHOR=2,OFFSET=-4,DEPTH=3,R=0.7,OTYPE=2,A=1,G=0.7}
AuxBar^3~d!3~4~5~6~7~8~9~
AuxBar^3~f~10!{SIZE=0.58,USE=1,B=0.2,COLOUR=1,ANCHOR=2,OFFSET=-4,DEPTH=3,R=0.7,OTYPE=2,A=1,G=0.7}
AuxBar^4~f~1!{SIZE=1,USE=5,R=1,COLOUR=1,ANCHOR=3,OFFSET=0,DEPTH=2,G=1,A=1,OTYPE=1,B=1}
AuxBar^4~f~2!{SIZE=1,USE=5,B=1,COLOUR=1,ANCHOR=3,OFFSET=0,DEPTH=4,R=1,OTYPE=2,A=1,G=1}
AuxBar^4~d!3~4~5~6~7~8~9~
AuxBar^4~f~10!{SIZE=1,USE=1,B=1,COLOUR=1,ANCHOR=3,OFFSET=0,DEPTH=4,R=1,OTYPE=2,A=1,G=1}
AuxBar^5~f~1!{SIZE=1,USE=5,R=0.631,COLOUR=1,ANCHOR=4,OFFSET=0,DEPTH=2,G=0.247,A=1,OTYPE=1,B=0.247}
AuxBar^5~f~2!{SIZE=1,USE=5,B=0.247,COLOUR=1,ANCHOR=4,OFFSET=0,DEPTH=4,R=0.631,OTYPE=2,A=1,G=0.247}
AuxBar^5~d!3~4~5~6~7~8~9~
AuxBar^5~f~10!{SIZE=1,USE=1,B=0.247,COLOUR=1,ANCHOR=4,OFFSET=0,DEPTH=4,R=0.631,OTYPE=2,A=1,G=0.247}
AuxBar^6~f~1!{SIZE=1,USE=5,R=1,COLOUR=1,ANCHOR=2,OFFSET=0,DEPTH=2,G=1,A=1,OTYPE=1,B=1}
AuxBar^6~f~2!{SIZE=1,USE=5,B=1,COLOUR=1,ANCHOR=2,OFFSET=0,DEPTH=4,R=1,OTYPE=2,A=1,G=1}
AuxBar^6~d!3~4~5~6~7~8~9~
AuxBar^6~f~10!{SIZE=1,USE=1,B=1,COLOUR=1,ANCHOR=2,OFFSET=0,DEPTH=4,R=1,OTYPE=2,A=1,G=1}
AuxBar^7~f~1!{SIZE=1,USE=5,R=0.8,COLOUR=1,ANCHOR=1,OFFSET=0,DEPTH=2,G=0.2,A=1,OTYPE=1,B=0.8}
AuxBar^7~f~2!{SIZE=1,USE=5,B=0.8,COLOUR=1,ANCHOR=1,OFFSET=0,DEPTH=4,R=0.8,OTYPE=2,A=1,G=0.2}
AuxBar^7~d!3~4~5~6~7~8~9~
AuxBar^7~f~10!{SIZE=1,USE=1,B=0.8,COLOUR=1,ANCHOR=1,OFFSET=0,DEPTH=4,R=0.8,OTYPE=2,A=1,G=0.2}
AuxBar^8~f~1!{SIZE=0.58,USE=1,R=0.078,COLOUR=1,ANCHOR=2,OFFSET=-3,DEPTH=3,G=0.737,A=1,OTYPE=2,B=0.875}
AuxBar^8~d!2~3~4~5~6~7~8~9~10~
AuxBar^9~f~1!{SIZE=0.98,USE=1,R=1,COLOUR=1,ANCHOR=1,OFFSET=2,DEPTH=5,G=1,A=1,OTYPE=1,B=1}
