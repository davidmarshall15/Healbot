...
DuplicateBars~v!true
Chat~t!{EOCOOM="false",EOCOOMV=20,MSG="Casting #s on #n",RESONLY="true",CHAN="",NOTIFY=0}
General~t!{OFREQ=0.07,OMIN=0.1,OMAX=0.95,HIDEBOSSF="false",HIDEPARTYF="false",FLUIDFREQ=10,STICKYSENSITIVITY=35,HIDERAIDF="true",STICKYFRAME="true",FLUIDBARS="false",HIDEPTF="false"}
...
DuplicateBars~v!true
Chat~t!{EOCOOM="false",EOCOOMV=20,MSG="Casting #s on #n",RESONLY="true",CHAN="",NOTIFY=0}
General~t!{OFREQ=0.07,OMIN=0.1,OMAX=0.95,FLUIDFREQ=10,HIDEPARTYF="false",HIDEBOSSF="false",STICKYSENSITIVITY=35,HIDERAIDF="true",STICKYFRAME="true",FLUIDBARS="false",HIDEPTF="false"}
