...
General~t!{OFREQ=0.07,STICKYSENSITIVITY=25,FLUIDBARS="true",HIDEBOSSF="true",HIDEPARTYF="false",OMAX=1,HIDERAIDF="true",HIDEPTF="false",STICKYFRAME="true",OMIN=0.2,FLUIDFREQ=12}
...
General~t!{OFREQ=0.07,STICKYSENSITIVITY=30,FLUIDBARS="false",FLUIDFREQ=11,HIDEPARTYF="false",OMIN=0.2,STICKYFRAME="true",HIDEPTF="false",HIDERAIDF="true",OMAX=1,HIDEBOSSF="true"}
...
DuplicateBars~v!false
Chat~t!{EOCOOM="true",EOCOOMV=5,MSG="Casting #s on #n",RESONLY="true",CHAN="",NOTIFY=2}
General~t!{OFREQ=0.07,STICKYSENSITIVITY=22,FLUIDBARS="false",FLUIDFREQ=12,HIDEPARTYF="false",OMIN=0.1,STICKYFRAME="true",HIDEBOSSF="true",HIDERAIDF="true",OMAX=0.95,HIDEPTF="false"}
